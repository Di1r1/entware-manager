        ...
        content.innerHTML = `
            <h2 style="display: flex; align-items: center; gap: 8px;">
                <span class="stat-icon" style="width: 28px; height: 28px;">
                    <svg class="icon" width="28" height="28"><use href="/entware-manager/icons.svg?v=5#icon-shield"/></svg>
                </span>
            ...
            <div id="monitor-status-panel" style="background: var(--command-block-bg); padding: 1rem; border-radius: 12px; margin-bottom: 1rem;">
                <div style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center;">
                    ...
                    <button id="monitor-start" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-play"/></svg> Запустить</button>
                    <button id="monitor-stop" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-stop"/></svg> Остановить</button>
                    <button id="monitor-restart" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-refresh"/></svg> Перезапустить</button>
            ...
            <div id="monitor-processes">
                ...
                <form id="monitor-settings-form">
                    ...
                    <button type="submit" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-disk"/></svg> Сохранить настройки</button>
                </form>
            </div>
            <div id="monitor-log">
                <h3>Лог событий</h3>
                <pre id="log-content" style="background: var(--pre-bg); padding: 0.5rem; height: 200px; overflow-y: auto;">Загрузка...</pre>
                <button id="clear-log" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-trash"/></svg> Очистить лог</button>
            </div>
        `;
    },
