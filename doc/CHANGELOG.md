...
- **Тема**: выбор цвета темы при наведении на иконку день/ночь появляется с задержкой 2 сек (при удержании мыши), переключение день/ночь кликом — мгновенное. Кэш `entware.js?v=71`.
