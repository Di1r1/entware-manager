...
- **Мобильный режим**: время в шапке больше не наезжает на верхнюю часть страницы при закрытом меню — высота закрытого сайдбара увеличена с 70px до 100px, время теперь видно целиком (`style.css?v=39`).
