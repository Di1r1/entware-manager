...
Важно: я только разработчик, протестировать установку на всех архитектурах не могу — есть только arm64. Если кто-то поставит на mips/mipsel/arm/x86 — напишите, работает или нет.
