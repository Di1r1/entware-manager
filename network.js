        ...
        content.innerHTML = `
            <h2 style="display: flex; align-items: center; gap: 8px;">
                <span class="stat-icon" style="width: 28px; height: 28px;">
                    <svg class="icon" width="28" height="28"><use href="/entware-manager/icons.svg?v=5#icon-router"/></svg>
                </span>
                Сеть
            </h2>
            <div id="network-status-panel" style="background: var(--command-block-bg); padding: 1rem; border-radius: 12px; margin-bottom: 1rem;">
                <div style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center;">
                    ...
                    <button id="network-start" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-play"/></svg> Запустить</button>
                    <button id="network-stop" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-stop"/></svg> Остановить</button>
                    <button id="network-restart" class="packages-delete-btn"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-refresh"/></svg> Перезапустить</button>
            ...
            <div id="network-content">
                ...
                <div id="tab-events" class="tab-content">
                    ...
                    <button id="refresh-events" class="packages-delete-btn" style="margin-top: 1rem;"><svg class="icon" width="16" height="16"><use href="/entware-manager/icons.svg?v=5#icon-refresh"/></svg> Обновить</button>
                </div>
            </div>
        `;
    },
